...
string1 = "Hello 12345 World"
new_list1 = [h for h in string1 if h.isdigit()]
...
# reader reads by lines by default
...
# Does range first, then condition, then Expression (double(x))
